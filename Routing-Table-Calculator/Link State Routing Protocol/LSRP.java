...
public class LSRP{
    ...
    LSRP(){
        ...
        Font font = new Font("TimesNewRoman", 1, 15);
        ta.setFont(font);
    ...
    public static String routingcal(int[][] graph, int source){
        ...
        //Code for Modifies Dijkstra's Algorithm including single paramter
    ...
    public static void main(String[] args) {
        ...
        LSRP T = new LSRP(); //Instantiating the object.
        ...
        System.out.println("Elapsed Time in milli seconds: "+ (endtime1-start1) + "ms");
